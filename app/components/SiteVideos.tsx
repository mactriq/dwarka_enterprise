  ...
  return (
    <section className="bg-[#F7F6F2] py-20 px-6 lg:px-20">
      ...
      <div className="relative flex items-center">
        ...
        <button
          onClick={prev}
          className="absolute -left-6 md:-left-10 z-10 p-2 rounded-full hover:scale-110 shadow-md bg-gray-100 text-black transition"
        >
        ...
        <button
          onClick={next}
          className="absolute -right-6 md:-right-10 z-10 p-2 rounded-full hover:scale-110 shadow-md bg-gray-100 text-black transition"
        >
